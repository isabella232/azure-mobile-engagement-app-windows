...
namespace Microsoft.Azure.Engagement.Overlay
{
    ...
    public class EngagementPageOverlay : EngagementPage
    {
        ...
        /* Engagement grid element used to insert notification into current page. */
        Grid mEngagementGrid;

        /* Engagement grid element used to insert announcements into current page. */
        Grid mAnnouncementGrid;
...
#pragma warning disable 4014
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            RunOnUI(() =>
            {
                ...
                /* Remove announcement from grid. */
                if (mAnnouncementGrid.Children.Contains(mAnnouncement))
                {
                    mAnnouncement.UnsetHandler();
                    mAnnouncementGrid.Children.Remove(mAnnouncement);
                }
